...
async function checkCurrentGame() {
  ...
  debug && $('.main-container').css('display', 'block');
...
async function checkValorantRank() {
  ...
  $('#statsIMG').attr('src', data.images ? data.images.large : 'https://trackercdn.com/cdn/tracker.gg/valorant/icons/tiersv2/0.png');
}
